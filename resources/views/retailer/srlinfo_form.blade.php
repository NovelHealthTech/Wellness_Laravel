...
<div class="card p-5 m-5">
    <form action="{{ route('retailer.srlformsubmit') }}" method="post">
        @csrf
        ...
        <div class="row">
            ...
            <input type="text" name="alternate_mobile" class="form-control" placeholder="Alternate Contact" value="{{ old('alternate_mobile') }}">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" value="{{ session('timing') }} {{ date('Y-m-d H:i:s') }}" class="form-control" name="booking_date" readonly>
                @error("booking_date")
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="city" placeholder="Enter the city" value="{{ old('city') }}">
                @error("city")
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="state" placeholder="Enter the state" value="{{ old('state') }}">
                @error("state")
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
