...
Route::get("/paymentchecking", function () {
...
route::get("/demo_checkout", function () {


    $clientId = "M1VPZ8VOW6UH_25120913183"; // Replace with your Client ID
    $clientVersion = 1;           // Replace with your Client Version
    $clientSecret = "NGQxNzhmZWMtY2NkZS00YjkyLThhNDEtY2VmNTE2YWRiMTQ0"; // Replace with your Client Secret
    $env = Env::UAT;
    ...
    $redirectUrl = route("payment"); // URL to which PhonePe will redirect after payment
